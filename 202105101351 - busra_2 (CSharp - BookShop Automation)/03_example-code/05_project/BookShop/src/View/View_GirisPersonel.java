...
public class View_GirisPersonel extends javax.swing.JFrame {

    public View_GirisPersonel() {
        initComponents();
    ...
    public void Giris() {
        ...
        if (new Controller_Kullanici().Kontrol(txtKullaniciAd.getText(), txtParola.getText())) {
            ...
            Model.Model_Kullanici kullanici = new Controller_Kullanici().Getir(txtKullaniciAd.getText(), txtParola.getText());
