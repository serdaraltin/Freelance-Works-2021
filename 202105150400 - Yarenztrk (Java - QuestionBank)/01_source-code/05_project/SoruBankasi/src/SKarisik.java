...
public class SKarisik extends Sinav{

	private ArrayList<Soru> sorular = new ArrayList<Soru>();
	
	public SKarisik(ArrayList<Soru> tumSorular) {
	...
	private void sinavYap() {
		...
		for (Soru soru : sorular) {
			switch (soru.getSoruCesidi()) {
				...
				case 'c': soruMetniYazdir(soru);	secenekleriYazdir((CoktanSecmeliSoru)soru);	cevapAl();	break;
