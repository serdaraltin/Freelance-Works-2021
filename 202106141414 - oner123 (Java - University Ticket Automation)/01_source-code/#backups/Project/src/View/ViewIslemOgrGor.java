...
public class ViewIslemOgrGor extends javax.swing.JFrame {

    ControllerOgretimGorevlisi controller = new ControllerOgretimGorevlisi();
    private ArrayList<OgretimGorevlisi> liste = null;
    private int no;

    private void Listele() {
        controller.Listele(liste, tbVeriler);
    }

    public ViewIslemOgrGor(ArrayList<OgretimGorevlisi> liste) {
        initComponents();
    ...
    private void btnEkleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEkleActionPerformed
        new ViewOgretimGorevlisi(liste).setVisible(true);
        Listele();
    ...
    private void btnGuncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuncelleActionPerformed
        new ViewOgretimGorevlisi(liste, no).setVisible(true);
        Listele();
    }//GEN-LAST:event_btnGuncelleActionPerformed

    private void btnSilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSilActionPerformed
        if (controller.Sil(liste, no)) {
