...
public class UIUrunPanel extends javax.swing.JFrame {
    ...
    private ArrayList<Urun> urunler = null;
    private Urun urun = new Urun();

    private void Listele() {
        controllerUrun.Listele(urunler, tbVeriler);
    }

    public UIUrunPanel(ArrayList<Urun> liste) {
        initComponents();
    ...
    private void btnEkleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEkleActionPerformed
        new UIUrun(urunler).setVisible(true);
        Listele();
    ...
    private void btnGuncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuncelleActionPerformed
        new UIUrun(urunler, urun).setVisible(true);
        Listele();
    ...
    private void btnAraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAraActionPerformed
        ...
        urun.setAd(txtAra.getText());
        controllerUrun.Ara(urunler, urun, tbVeriler);
    }//GEN-LAST:event_btnAraActionPerformed

    private void tabloSatirSec(ListSelectionEvent evt) {
        try {
            urun.setNo(Integer.parseInt(tbVeriler.getValueAt(tbVeriler.getSelectedRow(), 0).toString()));
        } catch (Exception ex) {
