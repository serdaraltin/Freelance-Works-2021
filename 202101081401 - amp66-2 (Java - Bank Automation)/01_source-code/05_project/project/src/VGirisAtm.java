...
public class VGirisAtm extends javax.swing.JFrame {
    ...
    public void Giris() {
        ...
        if (controller_Musteri.Kontrol(txtTcNo.getText())) {
            JOptionPane.showMessageDialog(this, "Hoş Geldiniz");
            MMusteri musteri = controller_Musteri.Getir(new MMusteri(txtTcNo.getText()));
            new VAtm(musteri).setVisible(true);
            this.dispose();
            return;
        }
