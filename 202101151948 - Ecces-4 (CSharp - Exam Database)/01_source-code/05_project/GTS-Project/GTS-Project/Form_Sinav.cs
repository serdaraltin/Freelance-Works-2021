...
namespace GTS_Project
{
    public partial class Form_Sinav : Form
    {
        ...
        private void Form_Personel_Load(object sender, EventArgs e)
        {
            ...
            islemler.CBDoldur(cbOgretimUyesi, "ogretim_uyesi", new int[] { 3, 4, 2 });
        ...
        private void btn_Ekle_Click(object sender, EventArgs e)
        {
            ...
            List<string> donemler = islemler.Donustur(islemler.Kayitlar("bolum"), 0);

            List<string> ogretimuyeleri = islemler.Donustur(islemler.Kayitlar("bolum"), 0);
