...
public class ViewOgrenci extends javax.swing.JFrame {
    ...
    public ViewOgrenci(ArrayList<Ogrenci> liste, int no) {
        ...
        this.ogrenciler = liste;
        this.ogrenci = (Ogrenci) controllerMain.Sec(liste, no);

        txtNo.setText(String.valueOf(ogrenci.getNo()));
        txtParola.setText(ogrenci.getParola());
        txtTcNo.setText(ogrenci.getTcNo());
        txtAd.setText(ogrenci.getAd());
        txtSoyad.setText(ogrenci.getSoyad());
        txtCinsiyet.setText(ogrenci.getCinsiyet());
        txtDogum.setText(ogrenci.getDogumTarih());
        txtTelefon.setText(ogrenci.getTelefon());
        txtEposta.setText(ogrenci.getEposta());
        txtAdres.setText(ogrenci.getAdres());
        txtBolum.setText(ogrenci.getBolum());
    }
    ...
    private void btnSilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSilActionPerformed
        if (controllerMain.Sil(ogrenciler, ogrenci.getNo())) {
    ...
    private void btnEkleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEkleActionPerformed
        ...
        ogrenci.setParola(txtParola.getText());
        ogrenci.setTcNo(txtTcNo.getText());
        ogrenci.setAd(txtAd.getText());
        ogrenci.setSoyad(txtSoyad.getText());
        ogrenci.setCinsiyet(txtCinsiyet.getText());
        ogrenci.setDogumTarih(txtDogum.getText());
        ogrenci.setTelefon(txtTelefon.getText());
        ogrenci.setEposta(txtEposta.getText());
        ogrenci.setAdres(txtAdres.getText());
        ogrenci.setBolum(txtBolum.getText());
        if (ogrenci.getNo() != 0) {
            ogrenci.setNo(Integer.valueOf(txtNo.getText()));
            if (controllerMain.Guncelle(ogrenciler, ogrenci)) {
            ...
            if (controllerMain.Ekle(ogrenciler, ogrenci)) {
