...
public class MLodgment extends MMain {
    ...
    public MLodgment(int Id) {
        super(Id);
    }

    public MLodgment(int Id, String kart_tur, int kart_Id, int miktar, String tarih) {
        super(Id);
    ...
    public MLodgment(String kart_tur, int kart_Id, int miktar, String tarih) {
        this.kart_tur = kart_tur;
        this.kart_Id = kart_Id;
        this.miktar = miktar;
        this.tarih = tarih;
