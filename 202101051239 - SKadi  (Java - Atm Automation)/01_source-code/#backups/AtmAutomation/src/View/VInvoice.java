...
public final class VInvoice extends javax.swing.JFrame {
    ...
    MBank bank;
    MCredit krediKart;
    CInvoice controller = new CInvoice();

    public VInvoice(String kart_tur, int kart_Id) {
        initComponents();
    ...
    private void btnIslemYapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIslemYapActionPerformed
        ...
        boolean sonuc = controller.Add(new MInvoice(
                        kart_tur,
                        Id,
                        txtKurum.getText(),
