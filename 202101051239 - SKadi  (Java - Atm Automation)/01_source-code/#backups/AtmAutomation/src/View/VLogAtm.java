...
public class VLogAtm extends javax.swing.JFrame {
    ...
    public void Giris() {
        ...
        CCustomer controller_Musteri = new CCustomer();
        if (controller_Musteri.Control(txtTcNo.getText())) {
            JOptionPane.showMessageDialog(this, "Hoş Geldiniz");
            MCustomer customer = controller_Musteri.Get(new MCustomer(txtTcNo.getText()));
            new VAtm(customer).setVisible(true);
            this.dispose();
            return;
        }
