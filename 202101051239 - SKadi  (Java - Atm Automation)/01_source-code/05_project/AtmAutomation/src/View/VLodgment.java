...
public final class VLodgment extends javax.swing.JFrame {
    ...
    MBank bank;
    MCredit krediKart;
    CLodgment controller = new CLodgment();

    public VLodgment(String kart_tur, int kart_Id) {
        initComponents();
    ...
    private void btnIslemYapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIslemYapActionPerformed
        ...
        boolean sonuc = controller.Add(new MLodgment(
                        kart_tur,
                        Id,
