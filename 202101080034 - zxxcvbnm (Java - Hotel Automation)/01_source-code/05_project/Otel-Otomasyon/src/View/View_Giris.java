...
public class View_Giris extends javax.swing.JFrame {
    ...
    public void Giris() {
        ...
        if (txtKullaniciAd.getText().equals("admin") && txtParola.getText().equals("admin")) {
            //yonetici panel
            new View_MenuAdmin().setVisible(true);
            this.dispose();
            return;
        }
        if (new Controller_Personel().Kontrol(txtKullaniciAd.getText(), txtParola.getText())) {
            //personel panel
            new View_MenuPersonel().setVisible(true);
            this.dispose();
            return;
        }
