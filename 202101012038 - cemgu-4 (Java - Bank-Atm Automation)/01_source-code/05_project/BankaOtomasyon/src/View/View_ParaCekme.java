...
public final class View_ParaCekme extends javax.swing.JFrame {
    ...
    Controller_ParaCekme controller = new Controller_ParaCekme();

    public View_ParaCekme(String kart_tur, int kart_Id) {
        initComponents();
