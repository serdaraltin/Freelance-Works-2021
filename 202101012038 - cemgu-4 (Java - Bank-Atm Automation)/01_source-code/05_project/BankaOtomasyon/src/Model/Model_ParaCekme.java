...
public class Model_ParaCekme extends Model_Main {
    ...
    public Model_ParaCekme() {
        super.setTabloAd("para_cekme");
    }

    public Model_ParaCekme(int Id) {
        super(Id);
    }

    public Model_ParaCekme(int Id, String kart_tur, int kart_Id, int miktar, String tarih) {
        super(Id);
    ...
    public Model_ParaCekme(String kart_tur, int kart_Id, int miktar, String tarih) {
        this.kart_tur = kart_tur;
        this.kart_Id = kart_Id;
        this.miktar = miktar;
        this.tarih = tarih;
