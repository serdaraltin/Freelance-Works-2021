...
public class View_Degistir extends javax.swing.JFrame {
    ...
    private void btnAraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAraActionPerformed
        controller_Bul.Bul(new Model_Bul(txtMetin, txtAranan.getText(), tamEslesme, yon));
    ...
    private void btnDegistirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDegistirActionPerformed
        controller_Degistir.Degistir(new Model_Degistir(txtMetin, txtAranan.getText(), txtDegistir.getText(), tamEslesme, yon));
    ...
    private void btnTumunuDegistirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTumunuDegistirActionPerformed
        controller_Degistir.TumunuDegistir(new Model_Degistir(txtMetin, txtAranan.getText(), txtDegistir.getText(), tamEslesme, yon));
