...
public class View_Marka extends javax.swing.JFrame {

    int Id = 0;
    String baslik = "MARKA";
    Controller_Marka controller = new Controller_Marka();
    ...
    public void Getir() {
        Model_Marka model = controller.Getir(new Model_Marka(Id));
