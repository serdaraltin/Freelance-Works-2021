...
public class View_Kategori extends javax.swing.JFrame {

    int Id = 0;
    String baslik = "KATEGORİ";
    Controller_Kategori controller = new Controller_Kategori();

    public View_Kategori() {
        initComponents();
        setTitle("EKLE");
    ...
    public void Getir() {
        Model_Kategori model = controller.Getir(new Model_Kategori(Id));
