...
public class SoruB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbuttonHesapla.setText("Klasik Asal Sayı Buldurma");
        jbuttonHesapla.setActionCommand("Klasik Asal Sayı Buldurma");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SoruB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
