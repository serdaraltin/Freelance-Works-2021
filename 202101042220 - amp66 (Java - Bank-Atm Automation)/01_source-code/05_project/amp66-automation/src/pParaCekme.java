...
public final class pParaCekme extends javax.swing.JFrame {

    String ktur;
    int id = 0;
    String title = "PARA ÇEKME";
    mlMusteri mMusteri;
    mlBankaKart mKBanka;
    mlKrediKart mKKredi;
    cParaCekme cont = new cParaCekme();

    public pParaCekme(String ktur, int kID) {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(btnIslemYap, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
