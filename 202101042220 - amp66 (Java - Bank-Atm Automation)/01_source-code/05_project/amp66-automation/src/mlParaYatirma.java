public class mlParaYatirma extends amlMain {
    ...
    public mlParaYatirma() {
        super.setblad("para_yatirma");
    }

    public mlParaYatirma(int id) {
        super(id);
    }

    public mlParaYatirma(int id, String ktur, int kID, int kMiktar, String kTarih) {
        super(id);
        this.ktur = ktur;
        this.kID = kID;
    ...
    public mlParaYatirma(String ktur, int kID, int kMiktar, String kTarih) {
        this.ktur = ktur;
        this.kID = kID;
        this.kMiktar = kMiktar;
        this.kTarih = kTarih;
