...
public class pListe extends javax.swing.JFrame {
    ...
    public void KayitlariListele() {
        ...
        cont.KayitlariListele(tb_Kayitlar);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnYenile, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAraActionPerformed
        ...
        if (!txtAra.getText().equals("")) {
            cont.KayitAra(tb_Kayitlar, txtAra.getText());
        } else {
            KayitlariListele();
        }
