...
public class MParaCekme extends Abs_M_Ana {
    ...
    public MParaCekme(int Id) {
        super(Id);
    }

    public MParaCekme(int Id, String kart_tur, int kart_Id, int miktar, String tarih) {
        super(Id);
    ...
    public MParaCekme(String kart_tur, int kart_Id, int miktar, String tarih) {
        this.kart_tur = kart_tur;
        this.kart_Id = kart_Id;
        this.miktar = miktar;
        this.tarih = tarih;
