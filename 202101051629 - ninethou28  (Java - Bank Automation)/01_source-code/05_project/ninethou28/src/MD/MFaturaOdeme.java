...
public class MFaturaOdeme extends Abs_M_Ana {
    ...
    public MFaturaOdeme(int Id) {
        super(Id);
    }

    public MFaturaOdeme(String kart_tur, int kart_Id, String kurum, int miktar, String tarih) {
    ...
    public MFaturaOdeme(int Id, String kart_tur, int kart_Id, String kurum, int miktar, String tarih) {
        super(Id);
        this.kart_tur = kart_tur;
        this.kart_Id = kart_Id;
        this.kurum = kurum;
