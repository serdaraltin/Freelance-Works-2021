...
public class VGirisBanka extends javax.swing.JFrame {
    ...
    public void Giris() {
        ...
        if (new CKullanici().Kontrol(txtKullaniciAd.getText(), txtParola.getText())) {

            MD.MKullanici kullanici = new CKullanici().Getir(new MKullanici(txtKullaniciAd.getText(), txtParola.getText()));
            if (kullanici.getTip().equals("Yönetici")) {
                new VYonetim().setVisible(true);
            }
