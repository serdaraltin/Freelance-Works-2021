...
public class VKrediKart extends javax.swing.JFrame {

    int Id = 0;
    String baslik = "KREDİ KART ONAY";
    CKrediKart controller = new CKrediKart();
    ...
    public void Getir() {
        MKrediKart model = controller.Getir(new MKrediKart(Id));
    ...
    private void btnKaydetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKaydetActionPerformed
        ...
        if (Id == 0) {
            boolean sonuc = controller.Ekle(new MKrediKart(
                            musteri_Id,
            ...
            boolean sonuc = controller.Guncelle(new MKrediKart(
                            Id,
                            musteri_Id,
                            Integer.valueOf(txtBakiye.getText()),
                            Integer.valueOf(txtLimit.getText())
