...
public class VMusteri extends javax.swing.JFrame {

    int Id = 0;
    String baslik = "MÜŞTERİ";
    CMusteri controller = new CMusteri();
    ...
    public void Getir() {
        MMusteri model = controller.Getir(new MMusteri(Id));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(52, 52, 52)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtTelefon, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
    ...
    private void btnKaydetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKaydetActionPerformed
        ...
        if (Id == 0) {
            ...
            boolean sonuc = controller.Ekle(new MMusteri(
                            txtUnvan.getText(),
                            txtTcno.getText(),
                            txtAd.getText(),
                            txtSoyad.getText(),
            ...
            boolean sonuc = controller.Guncelle(new MMusteri(
                            Id,
                            txtUnvan.getText(),
                            txtTcno.getText(),
                            txtAd.getText(),
