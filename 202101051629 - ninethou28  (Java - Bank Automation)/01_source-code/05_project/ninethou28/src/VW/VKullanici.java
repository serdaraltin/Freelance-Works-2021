...
import MD.MKullanici;
import javax.swing.JOptionPane;

public class VKullanici extends javax.swing.JFrame {

    int Id = 0;
    String baslik = "KULLANICI";
    CKullanici controller = new CKullanici();
    ...
    public void Getir() {
        MKullanici model = controller.Getir(new MKullanici(Id));
    ...
    private void btnKaydetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKaydetActionPerformed
        ...
        if (Id == 0) {
            ...
            boolean sonuc = controller.Ekle(new MKullanici(
            ...
            boolean sonuc = controller.Guncelle(new MKullanici(
                            Id,
                            cbTip.getSelectedItem().toString(),
                            txtKullaniciAd.getText(),
                            txtParola.getText()
